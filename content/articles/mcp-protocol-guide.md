...
1. **كم عدد الأدوات التي تصلها فعلًا اليوم؟** أداة أو اثنتان: التكلفة أعلى من العائد. خمس فأكثر، أو أدوات تتغيّر باستمرار: يبدأ التوحيد يدفع ثمنه.
2. **هل تحتاج العميل نفسه أن يصل إلى خوادم لم تكتبها أنت؟** هذه أقوى حجّة للبروتوكول: واجهة موحّدة تعني أن أداة طرفٍ ثالث تعمل بلا كود لصق خاص بها.
3. **من يملك الخادم الذي ستصله؟** خادم خارجي يعني أنك تمنح نموذجك قدرة كتبها غيرك. تعامل معه كتبعية طرفٍ ثالث كاملة: راجعها، وثبّت إصدارها، وحدّد صلاحياتها.
4. **هل صلاحياتك محدّدة لكل أداة على حدة؟** إن كان الجواب «الوكيل يملك ما أملك»، فالبروتوكول سيضخّم المشكلة لا يحلّها. أصلح الصلاحيات أولًا.
