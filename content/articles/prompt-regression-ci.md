...
1. **أعد التشغيل مرّة واحدة.** إن نجح، فالسبب تذبذب لا انحدار — لكن سجّل الحادثة: تكرارها يعني أن عتبتك ضيّقة أو أن مثالك هشّ.
2. **إن سقط مرّتين، اقرأ أيّ الأمثلة سقطت** لا كم مثالًا. سقوط ثلاثة أمثلة تخصّ نوعًا واحدًا من الأسئلة إشارة مختلفة تمامًا عن سقوط ثلاثة متفرّقة.
3. **صنّف السقوط في واحد من ثلاثة**: انحدار حقيقي يُصلَح، أو مثال قديم لم يعد يمثّل السلوك المطلوب فيُحدَّث بموافقة، أو عتبة خاطئة تُعاد معايرتها بقرار موثّق.
4. **لا تتجاوز البوابة إلّا بموافقة معلَنة** تُكتب في وصف الدمج: من وافق، ولماذا، ومتى يُراجَع القرار. التجاوز الصامت يتحوّل إلى عادة خلال أسبوعين.
