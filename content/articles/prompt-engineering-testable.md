...
1. **غيّر شيئًا واحدًا.** إعادة صياغة كاملة تخفي أيّ تعديل نفع وأيّها ضرّ، وتترك المُوجّه أطول بلا سبب معروف.
2. **شغّل على مجموعتك الذهبية قبل التعديل وبعده**، بالبذرة ودرجة الحرارة نفسيهما. من غير قياس قبليّ لا معنى لكلمة «تحسّن».
3. **انظر إلى ما ساء أيضًا.** التعديل الذي يرفع عشرة أمثلة ويُسقط ثلاثة قد يكون خسارة إن كانت الثلاثة هي حالاتك الحرجة. العدّ وحده يضلّل.
4. **ثبّت التعديل في الاختبارات** قبل نشره. المُوجّه الذي تحسّن ولم يُحفَظ توقّعه سيعود إلى ما كان عند أول تعديل لاحق.
5. **وثّق سبب التعديل في سطر واحد** بجوار المُوجّه. بعد ثلاثة أشهر لن يتذكّر أحد لماذا هذه الجملة موجودة، وستُحذف — ثم يعود العطل الذي وُضعت لأجله.
